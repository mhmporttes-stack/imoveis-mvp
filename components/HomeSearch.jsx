...
export default function HomeSearch() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-10 flex w-full max-w-3xl flex-col gap-3 rounded-[28px] border border-white/20 bg-white/95 p-3 shadow-[0_24px_80px_rgba(0,0,0,0.22)] backdrop-blur-xl transition duration-300 focus-within:-translate-y-0.5 focus-within:border-blue-200 focus-within:shadow-[0_30px_95px_rgba(23,105,209,0.28)] sm:flex-row">
