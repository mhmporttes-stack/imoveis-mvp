...
export async function listProspectingContacts(auth) {
  ...
  // "recent_attempt" só entra na fila compartilhada quando o prazo de espera
  // (available_after, 30 dias) já passou — vale para todo mundo, incluindo o
  // administrador geral: a fila mostra só o que está realmente disponível
  // para atendimento agora, sem exceção de papel.
