...
// Reaproveitado pelo Envio Manual (lib/whatsapp-manual-summary.js), que não
// depende de modelo aprovado pela Meta (é o próprio dono/gestor que manda
// pelo WhatsApp dele) — mesma faixa de tom, sem repetir os limites 200/100.
export function pickPerformanceTier(percent) {
  if (percent >= 200) return "top";
