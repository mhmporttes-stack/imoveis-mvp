...
export const PROSPECTING_SPEC = [
  ...
  { id: "r-nao-responde-p", type: "ref", entry: "obj-nao-responde", next: "p-apresentacao", label: "Não responde" },
  {
    ...
    message: "[Nome], meu nome é [Corretor], sou associado do corretor Matheus Machado. Vi que há um tempo você entrou em contato com interesse na compra de um imóvel. Hoje estou te chamando para saber como foi sua experiência, se você foi bem atendido e se deu tudo certo com a compra.",
...
export const LEAD_SPEC = [
  {
    ...
    message: "Olá, [Nome]! Aqui é o [Corretor], associado do corretor Matheus Machado. Vi que você pediu informações sobre o imóvel. Vou te ajudar por aqui! Antes de tudo: você está buscando pra morar ou pra investir?",
    options: [
...
export const ORGANIC_SPEC = [
  {
    ...
    message: "Olá, [Nome]! Aqui é o [Corretor], associado do corretor Matheus Machado. Que bom seu contato! Me conta: como você chegou até a gente?",
    options: [
