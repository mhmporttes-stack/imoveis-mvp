...
const TEMPLATE_DEFAULTS = {
  ...
  acompanhamento_superada:
    "*{corretor}, meta superada! 🎉*\n\nVocê alcançou *{meta_percentual} da sua meta* — um resultado excelente, parabéns pelo empenho de hoje!\n\nO mérito já está garantido. Se surgir oportunidade de ir além, ótimo — mas hoje já é motivo de comemorar. 👏{destaques}",
