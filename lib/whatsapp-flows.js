...
// Link de simulação dos Fluxos: abre DIRETO o formulário de simulação (sem a
// tela de escolha com "Atendimento rápido") — ver ?jornada=simulacao em
// components/simulation-form/LinkJourneyGate.jsx. O link pessoal do corretor
// (?ref=) continua o mesmo, só ganha o parâmetro.
function directSimulationLink(link) {
  try {
    const url = new URL(link);
    url.searchParams.set("jornada", "simulacao");
    return url.toString();
  } catch {
    return link;
  }
