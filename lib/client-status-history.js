...
export function statusHistoryEventLabel(status) {
  ...
  const labels = {
    [CLIENT_STATUS.AUTOMATED_SERVICE]: "Atendimento automático",
    ...
    [CLIENT_STATUS.MEETING_PENDING]: "Aguardando reunião",
    [CLIENT_STATUS.MEETING_DONE]: "Reunião realizada",
    [CLIENT_STATUS.SALE_COMPLETED]: "Venda realizada",
    [CLIENT_STATUS.SALE_FORMS]: "Formulários",
    [CLIENT_STATUS.SALE_RESERVATION]: "Reserva",
    [CLIENT_STATUS.SALE_CONTRACT]: "Contrato",
    ...
    [CLIENT_STATUS.DO_NOT_CONTACT]: "Cliente marcado como não contactar"
  };
