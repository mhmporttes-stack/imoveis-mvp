...
// Campos considerados dados internos/confidenciais da captação (aba
// "Informações Internas") — usado tanto pela API quanto pelo formulário
// de edição, num único lugar, pra nunca divergir entre o que é escondido
// na tela e o que é bloqueado no backend.
export const CAPTACAO_INTERNAL_FIELDS = [
  "ownerName",
  "ownerPhone",
  "ownerEmail",
  "street",
