...
// Substitui [Nome], [Cliente], [Corretor] e [Link] (link de simulação do corretor). Sem o dado, deixa o marcador
// para o corretor preencher à mão.
export function fillPlaceholders(text, { clientName = "", brokerName = "", simulationLink = "" } = {}) {
