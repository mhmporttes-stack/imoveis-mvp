...
import { CAMPAIGN_DESTINATION, CAMPAIGN_STATUS, getCampaign } from "./campaigns";
...
async function resolveExternalLinkAssignment(payload = {}) {
  ...
  return { campaign, isActiveCampaign, isTeamDistribution, providedRef, isDirectBrokerLink, responsibleUserId, distributionType, isRouletteAssignment };
}
